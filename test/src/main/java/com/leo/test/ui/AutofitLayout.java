    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(
                    attrs,
                    com.leo.test.R.styleable.AutofitTextView,
                    defStyle,
                    0);
            sizeToFit = ta.getBoolean(com.leo.test.R.styleable.AutofitTextView_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(com.leo.test.R.styleable.AutofitTextView_minTextSize,
                    minTextSize);
